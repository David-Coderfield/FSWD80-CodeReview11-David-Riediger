...
if (isset($_GET['id'])) {
  ...
  INNER JOIN `sights` ON sights.location_id=locations.id
  WHERE id=$id";
...
<body>
  <div class="container">
    ...
    <div class="w-50 mx-auto my-5" id="formcontent">
      <form action="actions/update_sight_a.php" method="post" accept-charset="utf-8" id="insertform">
        <!-- hidden input to post id -->
        <input type="hidden" name="id" value="<?= $id ?>">
        <table class="table table-secondary">
          <tr>
            <th colspan="2">
              <h3 class="text-center">Update Sight</h3>
            </th>
          </tr>
          <tr>
            <td>Title</td>
          ...
          <tr>
            <td>Sight type</td>
            <td><input class="form-control" name="type" value="<?=$row['type'] ?>"></td>
          </tr>
          <tr>
            <td></td>
